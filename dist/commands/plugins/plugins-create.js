...
export function createCreateCommand() {
    return new Command('create')
        ...
        try {
            ...
            logger.log('  Scripts available in package.json');
            logger.log("  'ziggy plugin register' to register your package and blocks");
        }
        catch (error) {
...
//# sourceMappingURL=plugins-create.js.map