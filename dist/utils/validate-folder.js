...
export function validateFolder() {
    ...
    try {
        ...
        consoleMsg('You do not appear to be in a Ziggy package folder. You should be in the root directory of your plugin package to run this command.', ColorEnum.ERROR);
        return false;
    }
}
