...
export interface BackupResponseDto {
     ...
     * @example "success"
     */
    s3CopyStatus: BackupResponseDtoS3CopyStatus;
    /**
     * Error message if S3 copy failed
     * @example "S3 bucket does not exist"
     */
    s3Error?: string;
}
 ...
 * @example "success"
 */
export declare enum BackupResponseDtoS3CopyStatus {
    Success = "success",
    Failed = "failed",
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    system: {
         ...
         */
        systemUpdateWorkerPoolSize: (key: string, value: string, params?: RequestParams) => Promise<HttpResponse<SystemMonitorDto, any>>;
        /**
         * No description
         *
         * @tags System
    ...
    ziggy: {
         ...
         */
        ifGetRunningFlows: (params?: RequestParams) => Promise<HttpResponse<RunningFlowDto[], any>>;
        /**
         * No description
         *
         * @tags Ziggy executions
