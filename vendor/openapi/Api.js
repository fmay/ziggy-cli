...
(function (ConnectionTypeEnum) {
    ...
    ConnectionTypeEnum["SMTP"] = "SMTP";
    ConnectionTypeEnum["Twilio"] = "Twilio";
    ConnectionTypeEnum["S3"] = "S3";
    ConnectionTypeEnum["AZURE_BLOB"] = "AZURE_BLOB";
    ...
    ConnectionTypeEnum["RedisEventStream"] = "Redis Event Stream";
    ConnectionTypeEnum["RedisPubSub"] = "Redis Pub Sub";
    ConnectionTypeEnum["IMAP"] = "IMAP";
...
(function (SystemKeys) {
    ...
    SystemKeys["JSWorkerPoolHeapSize"] = "JSWorkerPoolHeapSize";
...
(function (MessagingTypeEnum) {
    ...
    MessagingTypeEnum["RedisPubSub"] = "Redis Pub Sub";
    MessagingTypeEnum["RedisEventStream"] = "Redis Event Stream";
    MessagingTypeEnum["SMTP"] = "SMTP";
    MessagingTypeEnum["IMAP"] = "IMAP";
 ...
 * @example "success"
 */
export var BackupResponseDtoRemoteBackupStatus;
(function (BackupResponseDtoRemoteBackupStatus) {
    BackupResponseDtoRemoteBackupStatus["Success"] = "success";
 ...
 * @example "plugin"
 */
export var BlockConflictDtoConflictSource;
(function (BlockConflictDtoConflictSource) {
    BlockConflictDtoConflictSource["Core"] = "core";
    BlockConflictDtoConflictSource["Plugin"] = "plugin";
})(BlockConflictDtoConflictSource || (BlockConflictDtoConflictSource = {}));
...
(function (CreateMessagingDtoType) {
    ...
    CreateMessagingDtoType["RedisPubSub"] = "Redis Pub Sub";
    CreateMessagingDtoType["RedisEventStream"] = "Redis Event Stream";
    CreateMessagingDtoType["SMTP"] = "SMTP";
    CreateMessagingDtoType["IMAP"] = "IMAP";
...
(function (MessagingType) {
    ...
    MessagingType["RedisPubSub"] = "Redis Pub Sub";
    MessagingType["RedisEventStream"] = "Redis Event Stream";
    MessagingType["SMTP"] = "SMTP";
    MessagingType["IMAP"] = "IMAP";
...
(function (UpdateMessagingDtoType) {
    ...
    UpdateMessagingDtoType["RedisPubSub"] = "Redis Pub Sub";
    UpdateMessagingDtoType["RedisEventStream"] = "Redis Event Stream";
    UpdateMessagingDtoType["SMTP"] = "SMTP";
    UpdateMessagingDtoType["IMAP"] = "IMAP";
...
export class Api extends HttpClient {
    ...
    system = {
         ...
         */
        systemTestRemoteBackup: (params = {}) => this.request({
            path: `/system/test-remote-backup`,
            method: 'POST',
            format: 'json',
            ...params,
        }),
         ...
         */
        systemUpdateWorkerPoolHeapSize: (value, params = {}) => this.request({
            path: `/system/worker-pool-heap-size/${value}`,
            method: 'POST',
            format: 'json',
            ...params,
        }),
         ...
         */
        systemResetSystemPeaks: (params = {}) => this.request({
            path: `/system/reset-system-peaks`,
            method: 'POST',
            format: 'json',
            ...params,
        }),
         ...
         */
        systemControllerError500: (params = {}) => this.request({
            path: `/system/error500`,
            method: 'GET',
            ...params,
        }),
        /**
         ...
         */
        systemGetAliveInstances: (params = {}) => this.request({
         ...
         */
        systemGetAllInstancesStats: (params = {}) => this.request({
            path: `/system/instances/stats`,
            method: 'GET',
            format: 'json',
            ...params,
        }),
         ...
         */
        systemGetInstanceStats: (instanceId, params = {}) => this.request({
            path: `/system/instance/${instanceId}/stats`,
            method: 'GET',
            format: 'json',
            ...params,
        }),
         ...
         */
        systemToggleStatsCollection: (data, params = {}) => this.request({
            path: `/system/instances/stats-collection`,
            method: 'POST',
            body: data,
            type: ContentType.Json,
            format: 'json',
    ...
    ziggy = {
         ...
         */
        ifKillAllRunningFlows: (flowUuid, params = {}) => this.request({
            path: `/ziggy/kill-all-running-flows/${flowUuid}`,
            method: 'DELETE',
            ...params,
        }),
        /**
    ...
    plugins = {
         ...
         * @secure
         */
        pluginControllerCheckBlockExistence: (data, params = {}) => this.request({
            path: `/plugins/check-block-existence`,
            method: 'POST',
            body: data,
            secure: true,
            type: ContentType.Json,
         ...
         * @secure
         */
        pluginControllerGetPluginAsset: (pluginId, params = {}) => this.request({
            path: `/plugins/assets/${pluginId}/*`,
            method: 'GET',
            secure: true,
            ...params,
        }),
    ...
    openai = {
         ...
         */
        openaiEdgeAssistant: (data, params = {}) => this.request({
            path: `/openai/edge-ai-assistant`,
            method: 'POST',
            body: data,
            type: ContentType.Json,
            format: 'json',
    ...
    aiAgent = {
         ...
         */
        aiAgentExecuteGeneratePrompt: (data, params = {}) => this.request({
            path: `/ai-agent/execute-generate`,
            method: 'POST',
            body: data,
            type: ContentType.Json,
            format: 'json',
